...
const Footer = () => {
    return (
        <footer className="bg-biru text-white lg:px-28">
            ...
            <div className="bg-[#3E4B59] h-20 flex justify-center items-center">
                <h1 className="text-xl font-semibold">Copyright 2024 TEAM</h1>
            </div>
        </footer>
    );
};
